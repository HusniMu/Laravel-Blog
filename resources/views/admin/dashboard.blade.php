        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
            ...
            <div class="info-box bg-purple hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{$author_count}}" data-speed="15" data-fresh-interval="20">
                    </div>
                </div>
            </div>
            {{-- today new authors --}}
            <div class="info-box bg-deep-purple hover-zoom-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{$new_authors_today}}" data-speed="15" data-fresh-interval="20">
                    </div>
                </div>
            </div>
            {{-- total user --}}
